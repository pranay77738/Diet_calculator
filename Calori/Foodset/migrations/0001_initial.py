# Generated by Django 3.2.6 on 2021-08-04 22:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(to='Foodset.Category')),
            ],
        ),
        migrations.CreateModel(
            name='UserFoodItem',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('customer', models.ManyToManyField(blank=True, to='Foodset.Customer')),
                ('fooditem', models.ManyToManyField(to='Foodset.FoodItems')),
            ],
        ),
    ]
